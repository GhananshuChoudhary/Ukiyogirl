...
export default function Readers() {
  ...
  return (
    <section id="readers" className="py-24 px-6 bg-beige-warm  relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
          ...
          {READER_BENEFITS.map((benefit, index) => {
            return (
              <motion.div
                ...
                className="p-8 rounded-3xl bg-beige-light  border border-kashmir-mist/30  flex flex-col justify-between hover:shadow-xl hover:border-kashmir-lake/20 transition-all duration-300 relative overflow-hidden text-left group"
              >
                
                {/* Floating organic pattern */}
                <div className="absolute -top-10 -right-10 w-24 h-24 bg-kashmir-mist  rounded-full filter blur-xl opacity-30  group-hover:opacity-60 transition-opacity" />

                <div className="space-y-4 relative z-10">
                  
                  {/* Icon badge */}
                  <div className="p-3.5 rounded-2xl bg-beige-light  border border-kashmir-mist/30  text-golden-accent inline-block">
                  ...
                  <p className="font-sans text-xs text-kashmir-deep/85  font-light leading-relaxed">
                ...
                {/* Micro accent */}
                <div className="mt-8 pt-4 w-full flex items-center justify-between text-xs font-mono tracking-wider text-kashmir-lake  group-hover:text-golden-accent transition-colors">
        ...
        <div className="mt-16 text-center max-w-md mx-auto p-6 rounded-2xl bg-beige-light/50  border border-kashmir-mist/30 ">
          <p className="font-serif italic text-xs text-kashmir-deep leading-relaxed">
            {t(
